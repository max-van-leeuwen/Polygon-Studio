...
export class ConfigurationValidator extends BaseScriptComponent {
  onAwake() {
    if (
      ...
      throw new Error(
        "To run Spectacles Interaction Kit in the Lens Studio Preview, set the Preview Panel's Device Type Override to Spectacles, or the Simulation Mode to Avalon!"
      )
    }
  }
}
