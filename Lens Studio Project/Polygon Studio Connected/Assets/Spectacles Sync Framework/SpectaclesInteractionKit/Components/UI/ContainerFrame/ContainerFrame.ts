...
export class ContainerFrame extends BaseScriptComponent {
  ...
  /*
   * TODO remove deprecated billboarding calls
   * https://jira.sc-corp.net/browse/COREEXP-1131
   */
  ...
  /**
   * @param minimumSize set maximum scale of frame
   */
  ...
  /**
   * @param position gets current world position of frame
   */
  ...
  destroy = (): void => {
    ...
    if (!this.destroyed) {
      ...
      /*
       * This appears to crash Fiji
       * https://jira.sc-corp.net/browse/COREEXP-1173
       * super.destroy()
       */
      this.enabled = false
    }
  ...
  /**
   * @param opacity sets alpha of the glass border of the frame
   */
  ...
  /**
   * @param opacity sets alpha of the dark backing effect of the frame
   */
